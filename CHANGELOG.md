...
- Fixed register reads returning stale OR'ed data when a buffer slot is reused.
- Fixed byte-to-word assembly casting so 4-byte register reads work on boards with
  16-bit int (Uno, Mega).
